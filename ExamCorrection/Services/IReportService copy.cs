...
public interface IReportService
{
    ...
    Task<Result<(byte[] FileContent, string FileName)>> ExportStudentProgressPdfAsync(int studentId, string? chartImageBase64);
    Task<Result<(byte[] FileContent, string FileName)>> ExportAllStudentsProgressPdfAsync();
}